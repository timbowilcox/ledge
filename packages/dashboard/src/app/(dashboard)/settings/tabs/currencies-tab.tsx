...
// ---------------------------------------------------------------------------
// Settings > Currencies tab — currency settings and exchange rates display.
// ---------------------------------------------------------------------------

import { formatDate } from "@/lib/format";
import type { CurrencySetting, ExchangeRate } from "@kounta/sdk";

export function CurrenciesTab({ currencies, exchangeRates }: { currencies: CurrencySetting[]; exchangeRates: ExchangeRate[] }) {
